...
<br><br>
It may not look all that different than the previous release, but a lot of work was done to improve integration with the vanilla world, everything is now "directional", more fish and fishing methods were added, and there's a few other undocumented suprises, incuding (undoubtedly) a few more bugs!
<br>
