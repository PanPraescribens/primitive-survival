    ...
    public class BlockPSStairs : Block
    {
        public override bool OnBlockInteractStart(IWorldAccessor world, IPlayer byPlayer, BlockSelection blockSel)
        {
            if (byPlayer.Entity.Controls.Sneak) //sneak place only
            {
                ...
                if (newPath.Contains("normal"))
                {
                    //Debug.WriteLine("rotate " + newPath);
                    //rotate
                ...
                //else Debug.WriteLine("dont rotate " + newPath);
            }
        ...
        public override bool TryPlaceBlock(IWorldAccessor world, IPlayer byPlayer, ItemStack itemstack, BlockSelection blockSel, ref string failureCode)
        {
            ...
            if (halfQuarter % 2 != 0) //corner
            {
                ...
                //Debug.WriteLine("nsewio: " + nCnt + " " + sCnt + " " + eCnt + " " + wCnt + " " + inCnt + " " + outCnt);
                ...
                else
                {
                    ...
                    //Debug.WriteLine("si: " + sideCnt + " " + inCnt);
